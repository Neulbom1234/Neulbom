      ...
      <div className={style.card}>
                ...
                <svg width={30} viewBox="0 0 24 24" aria-hidden="true">
                  <g>
                    <path
                      ...
                      fill="white"  // 채우기 색상을 하얀색으로 설정
                      stroke="black" // 테두리 색상을 검은색으로 설정
                      stroke-width="0.2" // 테두리 두께를 1로 설정
                      ></path>
                  </g>
                </svg>
              }
        ...
        <div className={style.body}>
          <div className={style.meta}>
            ...
            <div className={style.hairSalon}>{post.hairSalon}</div>
            <div className={style.hairSalonAddress}>{post.hairSalonAddress}</div>
